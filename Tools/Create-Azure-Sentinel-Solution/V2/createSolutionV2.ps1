                ...
                if ($validJson) {
                    ...
                    if ($objectKeyLowercase -eq "workbooks") {
                      ...
                      <#   $workbookUiParameter = [PSCustomObject] @{
                        ...
                        if($contentToImport.TemplateSpec) {
                            ...
                            $baseMainTemplate.variables | Add-Member -NotePropertyName "workbookTemplateSpecName$workbookCounter" -NotePropertyValue "[concat(parameters('workspace'),'-wb-',variables('_workbookContentId$workbookCounter'))]"
                    ...
                    elseif ($objectKeyLowercase -eq "playbooks") {
                        ...
                        if($contentToImport.TemplateSpec)
                        {
                            ...
                            $baseMainTemplate.variables | Add-Member -NotePropertyName "playbookTemplateSpecName$playbookCounter" -NotePropertyValue ($IsLogicAppsCustomConnector ? "[concat(parameters('workspace'),'-lc-',variables('_playbookContentId$playbookCounter'))]" : "[concat(parameters('workspace'),'-pl-',variables('_playbookContentId$playbookCounter'))]")
                            # Add workspace resource ID if not available
                            if (!$baseMainTemplate.variables.workspaceResourceId) {
                                $baseMainTemplate.variables | Add-Member -NotePropertyName "workspaceResourceId" -NotePropertyValue "[resourceId('microsoft.OperationalInsights/Workspaces', parameters('workspace'))]"
                            }
                    ...
                    elseif ($objectKeyLowercase -eq "data connectors") {
                        ...
                        if ($contentToImport.TemplateSpec) {
                            ...
                            $baseMainTemplate.variables | Add-Member -NotePropertyName "dataConnectorTemplateSpecName$connectorCounter" -NotePropertyValue "[concat(parameters('workspace'),'-dc-',variables('_dataConnectorContentId$connectorCounter'))]"
                    ...
                    if ($file -match "(\.yaml)$") {
                        ...
                        if ($objectKeyLowercase -eq "hunting queries") {
                            ...
                            if($contentToImport.TemplateSpec) {
                                ...
                                $baseMainTemplate.variables | Add-Member -NotePropertyName "huntingQueryTemplateSpecName$huntingQueryCounter" -NotePropertyValue "[concat(parameters('workspace'),'-hq-',variables('_huntingQuerycontentId$huntingQueryCounter'))]"
                                if (!$baseMainTemplate.variables.workspaceResourceId) {
                                    $baseMainTemplate.variables | Add-Member -NotePropertyName "workspaceResourceId" -NotePropertyValue "[resourceId('microsoft.OperationalInsights/Workspaces', parameters('workspace'))]"
                                }
                            ...
                            if($contentToImport.TemplateSpec) {
                                ...
                                $baseMainTemplate.variables | Add-Member -NotePropertyName "analyticRuleTemplateSpecName$analyticRuleCounter" -NotePropertyValue "[concat(parameters('workspace'),'-ar-',variables('_analyticRulecontentId$analyticRuleCounter'))]"
                                if (!$baseMainTemplate.variables.workspaceResourceId) {
                                    $baseMainTemplate.variables | Add-Member -NotePropertyName "workspaceResourceId" -NotePropertyValue "[resourceId('microsoft.OperationalInsights/Workspaces', parameters('workspace'))]"
                                }
                    ...
                    # elseif($objectKeyLowercase -eq "parser") {
                        ...
                        if($contentToImport.TemplateSpec) {
                            ...
                            $baseMainTemplate.variables | Add-Member -NotePropertyName "parserTemplateSpecName$parserCounter" -NotePropertyValue "[concat(parameters('workspace'),'-pr-',variables('_parserContentId$parserCounter'))]"
                            # Add workspace resource ID if not available
                            if (!$baseMainTemplate.variables.workspaceResourceId) {
                                $baseMainTemplate.variables | Add-Member -NotePropertyName "workspaceResourceId" -NotePropertyValue "[resourceId('microsoft.OperationalInsights/Workspaces', parameters('workspace'))]"
                            }
